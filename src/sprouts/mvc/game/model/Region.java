...
public class Region {
	...
	private Edge outerBoundary;
	private List<Edge> innerBoundaries;
	private List<Sprout> innerSprouts;
	...
	public void setOuterBoundary(Edge outerBoundary) {
		this.outerBoundary = outerBoundary;
	}
	
	public void addInnerBoundary(Edge boundary) {
		innerBoundaries.add(boundary);
	}
	...
	public Edge getOuterBoundary() {
		return outerBoundary;
	}

	public void addInnerSprout(Sprout sprout) {
		innerSprouts.add(sprout);
	}
	
	public List<Edge> getInnerBoundaries() {
		return innerBoundaries;
	}
	
	public List<Sprout> getInnerSprouts() {
		return innerSprouts;
	}
