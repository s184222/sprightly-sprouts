...
import sprouts.mvc.game.model.move.RawMovePathGenerator;
import sprouts.tests.MoveHistory;
import sprouts.mvc.game.model.move.MoveException;
import sprouts.mvc.game.model.move.MoveNotationException;
...
public class GraphicalFacade {
	...
	public boolean intersectsNewLine(Line l) {
		Line line = new Line();
		line.addAll(l);
