	...
	public void drawForeground(ITessellator2D tessellator) {
		if (shouldDrawPreviousMove) {
			if (previousMove != null) {
				...
				/*
				Vec2 v0 = gameMenu.worldToView(path.get(0));
				Vec2 v1 = gameMenu.worldToView(path.get(1));
				Vec2 v2 = gameMenu.worldToView(path.get(7));
				Vec2 v3 = gameMenu.worldToView(path.get(8));
