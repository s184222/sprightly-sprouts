 ...
 * @author Christian
 */
public abstract class AbstractTextModel implements ITextModel {

	private final List<ITextModelListener> modelListeners;
	
	public AbstractTextModel() {
		modelListeners = new ArrayList<ITextModelListener>();
	}
	...
	protected void dispatchTextInsertedEvent(int offset, int count) {
		for (ITextModelListener listener : modelListeners)
